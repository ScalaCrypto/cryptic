...
/** Object Chill provides Kryo serialization and deserialization functionality.
  * It contains a Kryo serialization pool and given methods for serialization
  * and deserialization.
  *
  * The serializer method creates a new instance of Serializer[V].
  *
  * The serialize method converts a value of type V to a PlainText using Kryo
  * serialization.
  *
  * The deserialize method converts a PlainText back to a value of type V using
